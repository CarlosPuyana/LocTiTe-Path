...
public class principal {
  public static void main(String[] args) {
      ...
      System.out.println(contador + " campos");
       ...
       ResultSet rs2 = statement.executeQuery("SELECT payments.amount, customers.CustomerName FROM payments INNER JOIN customers ON payments.CustomerNumber=customers.CustomerNumber WHERE amount>30000");
      ...
      ResultSet rs3 = statement.executeQuery("SELECT firstName, lastName FROM employees WHERE reportsTo=1143");
